...
import neutron_fwaas.services.firewall.drivers.zorp.zorp_fwaas as fwaas
...
class ZorpFwaasTestCase(base.BaseTestCase):
    def setUp(self):
        super(ZorpFwaasTestCase, self).setUp()
        ...
        self.firewall = fwaas.ZorpFwaasDriver()
